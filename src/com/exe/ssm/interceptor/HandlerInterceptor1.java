...
public class HandlerInterceptor1 implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
		...
		System.out.println("第1个拦截器HandlerInterceptor1-->preHandle");
	...
	public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, ModelAndView modelAndView)
		...
		System.out.println("第1个拦截器HandlerInterceptor1-->postHandle");
	...
	public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception modelAndView)
		...
		System.out.println("第1个拦截器HandlerInterceptor1-->afterCompletion");
